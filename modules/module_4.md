# <span style="color:#f9b000">SVELTEKIT FRONTEND</span>
...
1. Go ahead and create a serializer dir, **init**.py and account.py file with the following code.
...
3. We now Open the new /app/backend/users/serializers/**init**.py file and add the following code.
...
5. We now Open the new /app/backend/users/views/**init**.py file and add the following code.
...
10. Open /app/backend/users/tests/**init**.py and add the following code.
